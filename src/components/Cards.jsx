          ...
          <Link to="/student-loan" className="text-decoration-none">
            <div className="card card-cover h-100 overflow-hidden text-bg-danger rounded-4 shadow-lg">
              <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                ...
                <p>Dreaming of exploring the world but worried about your budget? At  Phylee Travel and Tours Limited, we believe that travel should be accessible to everyone, including students. With our assistance in applying for student loans, you can embark on the journey of a lifetime without financial stress.</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <Link to="/group-travel" className="text-decoration-none">
            <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
              <div className="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
                ...
                <p>Planning a group trip can be daunting, but at  Phylee Travel and Tours Limited, we make it easy and enjoyable. Whether you're organizing a family reunion, corporate retreat, or a trip with friends, our expert team is here to create seamless and memorable group travel experiences.</p>
              </div>
            </div>
          </Link>
        </div>
